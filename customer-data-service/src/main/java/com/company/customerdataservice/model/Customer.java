...
public class Customer implements Serializable
{
    ...
    /**
     * Note: because id is autogenerated, when we add
     *       a customer record, we do not have to provide
     *       a unique id. This also allows us to add a new record to the
     *       customer table without the database complaining
     */
    @Id
